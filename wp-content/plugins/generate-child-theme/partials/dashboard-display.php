            ...
            <form action="admin-post.php" method="post" id="create_child_form">
                ...
                <table class="form-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="child_theme_name" class="widefat" required placeholder="<?php esc_html_e('Your child theme\'s name', 'generate-child-theme'); ?>" />
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <textarea name="child_theme_description" class="widefat" placeholder="<?php esc_html_e('Brief description of your child theme.', 'generate-child-theme'); ?>"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <input type="text" name="child_theme_author" class="widefat" placeholder="<?php esc_html_e('Anonymous', 'generate-child-theme'); ?>" />
                        </td>
                    </tr>
                    <tr>
                        <th>
                ...
                <?php // Output nonce field in the form
                wp_nonce_field('generate_child_theme_nonce', 'generate_child_theme_nonce_field'); ?>
            </form>
        </div><!-- .content -->
    </div><!-- .content-wrapper -->
